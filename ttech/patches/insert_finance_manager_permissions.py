...
def execute():
	print("Started Copying All Finance Roles to Finance Manager.....")

	fm_perm = ['read', 'write', 'create', 'select', 'delete', 'cancel', 'amend', 'print', 
	...
	for doc_type in all_accounts_manager_allowed_doctype:
		...
		add_permission(doc_type.parent, "Finance Manager", permlevel=doc_type.permlevel, ptype=None)
		for perm in fm_perm:
			update_permission_property(doc_type.parent, "Finance Manager", doc_type.permlevel, perm, doc_type[perm])

	print("All Accounts Manager Perms Copied to Finance Manager")
	...
	print("All Accounts User Role Copied to Finance Manager")