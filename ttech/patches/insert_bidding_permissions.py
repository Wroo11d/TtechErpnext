...
def execute():
	print("Started Copying All Sales Manager Roles to Bidding....")
	...
	for doc_type in all_accounts_manager_allowed_doctype:
		...
		add_permission(doc_type.parent, "Bidding", permlevel=doc_type.permlevel, ptype=None)
		for perm in fo_perm:
			update_permission_property(doc_type.parent, "Bidding", doc_type.permlevel, perm, doc_type[perm])

	print("All Sales Manager Perms Copied to Bidding")
	...
	print("All Sales User Role Copied to Bidding")