...
def execute():
	print("Started Copying All Sales Roles to Research and Development.....")
	...
	for doc_type in all_accounts_manager_allowed_doctype:
		...
		add_permission(doc_type.parent, "Research and Development", permlevel=doc_type.permlevel, ptype=None)
		for perm in fo_perm:
			update_permission_property(doc_type.parent, "Research and Development", doc_type.permlevel, perm, doc_type[perm])

	print("All Sales Manager Perms Copied to Research and Development")
	...
	print("All Sales User Role Copied to Research and Development")